...
PyObject* EntityCall::__unpickle__(PyObject* self, PyObject* args)
{
	...
	// add by huyf 2019.08.12:如果是本进程的实体，则不用生成 EntityCall, 直接获取本进程的entity实体
	...
	// add end:如果是本进程的实体，则不用生成 EntityCall, 直接获取本进程的entity实体
...
{
	static PyMethodDef __unpickle__Method = {"EntityCall", (PyCFunction)&EntityCall::__unpickle__, METH_VARARGS, 0};
