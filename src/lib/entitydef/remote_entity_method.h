...
/*
add by huyf 2019.08.20
						RemoteEntityMethod
								|
	EntityRemoteMethod(base)		EntityRemoteMethod(cell)
*/
...
public:	
	RemoteEntityMethod(MethodDescription* methodDescription, EntityCallAbstract* entityCall, PyTypeObject* pyType = NULL);
