										...
										uint32 wbuffer)
{
	...
	INFO_MSG(fmt::format("NetworkInterface::initialize({}): address {}, SOMAXCONN={}, rBufSize={}, wBufSize={}.\n", 
		pEndPointName, address.c_str(), backlog, pEP->getBufferSize(SO_RCVBUF), pEP->getBufferSize(SO_SNDBUF)));
