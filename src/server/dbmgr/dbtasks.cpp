...
bool DBTaskExecuteRawDatabaseCommand::db_thread_process()
{
	...
	DEBUG_MSG(fmt::format("huyf-yh: DBTaskExecuteRawDatabaseCommand::db_thread_process(): MemoryStream (rpos={}, wpos={})! componentID_={}, componentType_={}, callbackID={}\n",
		pDatas_->rpos(), pDatas_->wpos(), componentID_, componentType_, callbackID_));
	//add end
...
bool DBTaskExecuteRawDatabaseCommandByEntity::db_thread_process()
{
	...
	(*pDatas_).readBlob(sdatas_);
	//add by huyf 2019.06.21
	DEBUG_MSG(fmt::format("huyf-yh: DBTaskExecuteRawDatabaseCommandByEntity::db_thread_process(): MemoryStream (rpos={}, wpos={})! componentID_={}, componentType_={}, callbackID={}\n",
		pDatas_->rpos(), pDatas_->wpos(), componentID_, componentType_, callbackID_));
	//add end
...
bool DBTaskWriteEntity::db_thread_process()
{
	...
	//add by huyf 2019.06.21
	DEBUG_MSG(fmt::format("huyf-yh: DBTaskWriteEntity::db_thread_process(): MemoryStream (rpos={}, wpos={})! entityID={}, sid={}, callbackID={}, shouldAutoLoad={}, address={}, pdbi_->name={}\n",
		pDatas_->rpos(), pDatas_->wpos(), eid_, sid_, callbackID_, shouldAutoLoad_, addr_.c_str(), pdbi_->name()));
	//add end
									   ...
									   const std::string& passwd, const std::string& datas, ACCOUNT_INFOS& info)
{
	...
	DEBUG_MSG(fmt::format("huyf-yh: DBTaskCreateAccount::writeAccount(): is ok account script[{}], create[{}] error!\n",
		DBUtil::accountScriptName(), accountName));
...
{
	DEBUG_MSG(fmt::format("huyf-yh: DBTaskEntityOffline::db_thread_process: {}, entityType={}.\n", EntityDBTask_entityDBID(), sid_));
...
bool DBTaskAccountLogin::db_thread_process()
{
	...
	DEBUG_MSG(fmt::format("huyf-yh: DBTaskAccountLogin::db_thread_process(): is ok script[{}], login[{}] pdbi_->name={} failed!\n",
		DBUtil::accountScriptName(), accountName_, pdbi_->name()));
	...
	DEBUG_MSG(fmt::format("huyf-yh: Dbmgr::DBTaskAccountLogin:db_thread_process is ok... loginName={}, accountName={}, success={}, componentID={}, entityID={}, dbid={}, flags={}, deadline={}.\n",
		loginName_,
		accountName_,
		retcode_,
		componentID_,
...
{
	DEBUG_MSG(fmt::format("huyf-yh: Dbmgr::DBTaskQueryEntity::db_thread_process: {}, dbid={}, entityID={}, wasActive={}, queryMode={}, componentID={}, success={}.\n",
