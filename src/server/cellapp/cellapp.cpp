...
//-------------------------------------------------------------------------------------	
//add by huyf 2019.07.18:查看进程是否可以进行关闭(只有在cellapp进程执行完关闭后才会执行baseapp进程关闭)
...
//add end:查看进程是否可以进行关闭(只有在cellapp进程执行完关闭后才会执行baseapp进程关闭)
...
bool Cellapp::installPyModules()
{
	...
	APPEND_SCRIPT_MODULE_METHOD(getScript().getModule(),		setMapTileNavCost,				SpaceMemory::__py_SetMapTileNavCost,							METH_VARARGS,			0);
	APPEND_SCRIPT_MODULE_METHOD(getScript().getModule(),		getMapTileNavCost,				SpaceMemory::__py_getMap,										METH_VARARGS,			0);
	APPEND_SCRIPT_MODULE_METHOD(getScript().getModule(),		 setTileMapOrigin,				SpaceMemory::__py_SetTileMapOrigin,							METH_VARARGS,			0);
	...
	APPEND_SCRIPT_MODULE_METHOD(getScript().getModule(),		addSpaceMultipleTilesGeometryMapping, SpaceMemory::__py_AddSpaceMultipleTilesGeometryMapping,		METH_VARARGS,			0);
    APPEND_SCRIPT_MODULE_METHOD(getScript().getModule(),        addLayerOneTilesGeometryMapping, SpaceMemory::__py_AddLayerOneTilesGeometryMapping,            METH_VARARGS,           0);
    APPEND_SCRIPT_MODULE_METHOD(getScript().getModule(),        removeLayerOneTilesGeometryMapping, SpaceMemory::__py_RemoveLayerOneTilesGeometryMapping,     METH_VARARGS,           0);
    APPEND_SCRIPT_MODULE_METHOD(getScript().getModule(),        addLayerOneTilesById,           SpaceMemory::__py_AddLayerOneTilesById,                       METH_VARARGS,           0);
    APPEND_SCRIPT_MODULE_METHOD(getScript().getModule(),        loadAirWalls,                   SpaceMemory::__py_LoadAirWalls,                               METH_VARARGS,           0);
	APPEND_SCRIPT_MODULE_METHOD(getScript().getModule(),		addLayerOneTilesFromBytes,      SpaceMemory::__py_AddLayerOneTilesFromBytes,				  METH_VARARGS,				0);
...
PyObject* Cellapp::__py_createEntity(PyObject* self, PyObject* args)
{
	...
	INFO_MSG(fmt::format("huyf-yh: Cellapp::__py_createEntity: entityType={} spaceID={}\n", entityType, spaceID));
	...
	if(pEntity != NULL)
	{
		...
		{
			DEBUG_MSG(fmt::format("huyf-yh: Entity::__py_createEntity-before p={:p} scriptName={} id={} ob_refcnt = {}\n", (void*)pEntity, pEntity->scriptName(), pEntity->id(), ((PyObject *)pEntity)->ob_refcnt));
		}
	...
	if ((((PyObject *)pEntity)->ob_type->tp_name, "CNpc") == 0)
	{
		DEBUG_MSG(fmt::format("huyf-yh: Entity::__py_createEntity-after p={:p} scriptName={} id={} ob_refcnt = {}\n", (void*)pEntity, pEntity->scriptName(), pEntity->id(), ((PyObject *)pEntity)->ob_refcnt));
	}
	return pEntity;
}
...
void Cellapp::reqWriteToDBFromBaseapp(Network::Channel* pChannel, KBEngine::MemoryStream& s)
{
	...
	INFO_MSG(fmt::format("huyf-yh: Cellapp::reqWriteToDBFromBaseapp: entityID={} callbackID={} shouldAutoLoad={}.\n",
		entityID, callbackID, shouldAutoLoad));
	//add end
...
void Cellapp::onCreateCellEntityInNewSpaceFromBaseapp(Network::Channel* pChannel, KBEngine::MemoryStream& s)
{
	...
	if(space != NULL)
	{
		...
		if (strcmp(entityType.c_str(), "ReikiPoint") == 0)
		{
			int i = 0;
		}
		if (strcmp(entityType.c_str(), "Npc") == 0)
		{
			int i = 0;
		}
		if (strcmp(entityType.c_str(), "CNpc") == 0)
		{
			int i = 0;
		}
		//add end
...
void Cellapp::onCreateCellEntityFromBaseapp(Network::Channel* pChannel, KBEngine::MemoryStream& s)
{
	...
	_onCreateCellEntityFromBaseapp(entityType, createToEntityID, entityID, &s, hasClient, inRescore, componentID, spaceID);
											...
											SPACE_ID spaceID)
{
	...
	DEBUG_MSG(fmt::format("Cellapp::onCreateCellEntityFromBaseapp: spaceID={}, entityType={}, entityID={}, componentID={}\n", 
	...
	if(space != NULL && space->isGood())
	{
		...
		if (strcmp(entityType.c_str(), "Npc") == 0)
		{
			DEBUG_MSG(fmt::format("Cellapp::onCreateCellEntityFromBaseapp: spaceID={}, id={} entityType={}, entityID={}, componentID={}\n",
				spaceID, e->id(), entityType.c_str(), entityID, componentID));
			int i = 0;
		}
		if (strcmp(entityType.c_str(), "CNpc") == 0)
		{
		...
		Py_INCREF(e);
		if ((((PyObject *)e)->ob_type->tp_name, "CNpc") == 0)
		{
			DEBUG_MSG(fmt::format("huyf-yh: Entity::onCreateCellEntityFromBaseapp-Py_INCREF p={:p} scriptName={} id={} ob_refcnt = {}\n", (void*)e, e->scriptName(), e->id(), ((PyObject *)e)->ob_refcnt));
		}
...
//-------------------------------------------------------------------------------------
//add by huyf 2019.07.08:实体销毁-3
void Cellapp::onDestroyCellEntityFromBaseapp(Network::Channel* pChannel, ENTITY_ID eid)
{
	DEBUG_MSG(fmt::format("huyf-yh: Cellapp::onDestroyCellEntityFromBaseapp: entityID={}\n", eid));
	destroyEntity(eid, true);		//add by huyf 2019.07.08:bool EntityApp<E>::destroyEntity(ENTITY_ID entityID, bool callScript)
}
...
void Cellapp::reqTeleportToCellApp(Network::Channel* pChannel, MemoryStream& s)
{
	...
	if ((((PyObject *)e)->ob_type->tp_name, "CNpc") == 0)
	{
		DEBUG_MSG(fmt::format("huyf-yh: Entity::reqTeleportToCellApp-Py_INCREF p={:p} scriptName={} id={} ob_refcnt = {}\n", (void*)e, e->scriptName(), e->id(), ((PyObject *)e)->ob_refcnt));
	}
...
void Cellapp::reqTeleportToCellAppCB(Network::Channel* pChannel, MemoryStream& s)
{
	...
	Py_INCREF(entity);
	if ((((PyObject *)entity)->ob_type->tp_name, "CNpc") == 0)
	{
		DEBUG_MSG(fmt::format("huyf-yh: Entity::reqTeleportToCellAppCB-Py_INCREF p={:p} scriptName={} id={} ob_refcnt = {}\n", (void*)entity, entity->scriptName(), entity->id(), ((PyObject *)entity)->ob_refcnt));
	}
...
int Cellapp::raycast(SPACE_ID spaceID, int layer, const Position3D& start, const Position3D& end, std::vector<Position3D>& hitPos)
{
	...
	return pSpace->raycast(layer, start, end, hitPos);
}
