...
public:
	...
	*/
	...
	/**
		移动节点
	*/
	void moveNodeX(CoordinateNode* pNode, float px, CoordinateNode* pCurrNode, bool equalMove);
	void moveNodeY(CoordinateNode* pNode, float py, CoordinateNode* pCurrNode, bool equalMove);
	void moveNodeZ(CoordinateNode* pNode, float pz, CoordinateNode* pCurrNode, bool equalMove);
