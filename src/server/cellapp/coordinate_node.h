...
#define COORDINATE_NODE_FLAG_BOUNDARIES		(COORDINATE_NODE_FLAG_POSITIVE_BOUNDARY | COORDINATE_NODE_FLAG_NEGATIVE_BOUNDARY)
...
public:
	...
	*/
	virtual void update();
	virtual bool hasEntity(int x, int z) { return false; };
